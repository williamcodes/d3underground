...
base_url = "http://api.wunderground.com/api/ed81498dd08a91f6/history_#{year}#{day}/q/NY/New_York.json"
...
years.each do |year|
  days.each do |day|
    url = "http://api.wunderground.com/api/ed81498dd08a91f6/history_#{year}#{day}/q/NY/New_York.json"
    data = Net::HTTP.get('api.wunderground.com', '/api/ed81498dd08a91f6/history_#{year}#{}/q/NY/New_York.json')
  end
end